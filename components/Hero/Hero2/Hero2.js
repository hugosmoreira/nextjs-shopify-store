    ...
    return (
      <div className="hero hero2">
        <div className="hero2__collection1">
          <img src="https://images.pexels.com/photos/6626903/pexels-photo-6626903.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" className="hero2__bg" />
        ...
        <div className="hero2__collection2">
          ...
          <div className="hero2__content-container">
            <div className="hero2__info">
              <a href="#" className="hero2__button">Woman</a>
            </div>
          </div>
        </div>
